...
const Sidebar = () => {
  ...
  // If the inner width is greater than 786px then it will call this function
  useEffect(() => {
    const handleResize = () => {
  ...
  // if the sidebar is open and inner width is less than 768 then it will collapse
            ...
            <div className={sidebarStyles.headerContent}>
              <div className={sidebarStyles.logoContainer}>
                <div className={sidebarStyles.logoIcon}>
                  <BookOpen size={28} className="text-indigo-700"></BookOpen>
                </div>
                <div>
                  <h1 className={sidebarStyles.logoTitle}>Tech Quiz</h1>
                  <p className={sidebarStyles.logoSubtitle}>
                    Test your knowlegde and improve skills
                  </p>
                </div>
              </div>
          ...
          <div className={sidebarStyles.sidebarFooter}>
            <div className={sidebarStyles.footerContent}>
              <div className={sidebarStyles.footerContentCenter}>
                <p>Master your skills at a time</p>
